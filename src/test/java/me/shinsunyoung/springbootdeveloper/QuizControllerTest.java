...
import me.shinsunyoung.springbootdeveloper.QuizController.Code;
...
class QuizControllerTest {
    ...
    // ObjectMapper는 Jackson 라이브러리에서 제공하는 클래스로 객체와 JSON 간의 변환을 처리해줍니다.
    @Autowired
    ...
    // 문제 1 : GET 요청을 보내 응답 코드마다 예상하는 응답을 반환하는지 검증하는 테스트를 작성하세요.
    ...
    // 문제 2 : GET 요청을 보내 응답 코드마다 예상하는 응답을 반환하는지 검증하는 테스트를 작성하세요.
    ...
    // 문제 3 : POST 요청을 보내 응답 코드마다 예상하는 응답을 반환하는지 검증하는 테스트를 작성하세요.
    ...
    // 문제 4 : POST 요청을 보내 응답 코드마다 예상하는 응답을 반환하는지 검증하는 테스트를 작성하세요.
